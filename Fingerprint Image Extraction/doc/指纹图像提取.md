...
自适应阈值可以看成一种局部性的阈值，通过设定一个区域大小，比较这个点与区域大小里面像素点 的平均值（或者其他特征）的大小关系确定这个像素点的情况
...
<img src="../Resources/origin_image.png" alt="origin_image" style="zoom:50%;" />

**简单阈值处理**

<img src="../Resources/global_thresholding.png" alt="global_thresholding" style="zoom:50%;" />

**Adaptive Mean Thresholding 阈值处理**

<img src="../Resources/adaptive_mean_thresholding.png" alt="adaptive_mean_thresholding" style="zoom:50%;" />

**Adaptive Gaussian Thresholding 阈值处理**

<img src="../Resources/adaptive_gaussian_threshold.png" alt="adaptive_gaussian_threshold" style="zoom:50%;" />
...
**OTSU**用来自动对基于聚类的图像进行二值化，或者说，将一个灰度图像退化为二值图像。
